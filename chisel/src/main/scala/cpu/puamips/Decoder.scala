...
class Decoder extends Module {
  ...
  // @formatter:off
    ...
    Array(         /*   instvalid  | reg1_read     | reg2_read     | alusel       | aluop      | wreg           | wd     | immType */
      ...
      // MADD      -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_MADD , WRITE_DISABLE  , WRA_X  , IMM_N  ),
      // MADDU     -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_MADDU, WRITE_DISABLE  , WRA_X  , IMM_N  ),
      // MSUB      -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_MSUB , WRITE_DISABLE  , WRA_X  , IMM_N  ),
      // MSUBU     -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_MSUBU, WRITE_DISABLE  , WRA_X  , IMM_N  ),
      // DIV       -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_DIV  , WRITE_DISABLE  , WRA_X  , IMM_N  ),
      // DIVU      -> List(INST_VALID , READ_ENABLE   , READ_ENABLE   , EXE_RES_NOP , EXE_DIVU , WRITE_DISABLE  , WRA_X  , IMM_N  ),
