...
class Decoder extends Module {
  ...
  val signals: List[UInt] = ListLookup(
    ...
    Array( /* inst_valid | reg1_ren | reg2_ren | fusel | op | reg_wen | reg_waddr | imm_type | dual_issue */
      ...
      WAIT    -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_NOP, EXE_NOP,     WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
      ...
      // Cache
      CACHE -> List(INST_VALID, READ_ENABLE, READ_DISABLE, FU_NOP, EXE_CACHE, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
    ),
    // @formatter:on
  )
