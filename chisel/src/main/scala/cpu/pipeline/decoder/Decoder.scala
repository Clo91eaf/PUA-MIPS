...
class Decoder extends Module {
  ...
  val signals: List[UInt] = ListLookup(
    //@formatter:off
    inst,
    List(INST_INVALID, READ_DISABLE, READ_DISABLE, FU_NOP, EXE_NOP, WRITE_DISABLE, WRA_X, IMM_N, DUAL_ISSUE),
    Array( /* inst_valid | reg1_ren | reg2_ren | fusel | op | reg_wen | reg_waddr | imm_type | dual_issue */
      // NOP
      NOP -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_NOP, EXE_NOP, WRITE_DISABLE, WRA_X, IMM_N, DUAL_ISSUE),
      // 位操作
      ...
      // Move
      // MOVN      -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_MF   , EXE_MOVN , WRITE_ENABLE , WRA_T1  , IMM_N  , DUAL_ISSUE),
      // MOVZ      -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_MF   , EXE_MOVZ , WRITE_ENABLE , WRA_T1  , IMM_N  , DUAL_ISSUE),
      ...
      // C0的Move指令
      MFC0 -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_MFC0, EXE_MFC0, WRITE_ENABLE, WRA_T2, IMM_N, DUAL_ISSUE),
      MTC0 -> List(INST_VALID, READ_DISABLE, READ_ENABLE, FU_MTC0, EXE_MTC0, WRITE_DISABLE, WRA_X, IMM_N, DUAL_ISSUE),
      ...
      // Trap
      // TEQ       -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TEQ  , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TEQI      -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TEQ  , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      // TGE       -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TGE  , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TGEI      -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TGE  , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      // TGEIU     -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TGEU , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      // TGEU      -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TGEU , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TLT       -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TLT  , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TLTI      -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TLT  , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      // TLTU      -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TLTU , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TLTIU     -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TLTU , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      // TNE       -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE   , FU_TRAP   , EXE_TNE  , WRITE_DISABLE  , WRA_X     , IMM_N  , DUAL_ISSUE),
      // TNEI      -> List( INST_VALID  , READ_ENABLE   , READ_DISABLE  , FU_TRAP   , EXE_TNE  , WRITE_DISABLE  , WRA_X     , IMM_LSE, DUAL_ISSUE),
      ...
      // BEQL      -> List( INST_VALID , READ_ENABLE   , READ_ENABLE   , FU_BR , EXE_EQ   , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BNEL      -> List( INST_VALID , READ_ENABLE   , READ_ENABLE   , FU_BR , EXE_NE   , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BGTZL     -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_GTZ  , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BLEZL     -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_LEZ  , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BGEZL     -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_GEZ  , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BGEZALL   -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_GEZAL, WRITE_ENABLE   , WRA_T3 , IMM_N  , DUAL_ISSUE),
      // BLTZL     -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_LTZ  , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      // BLTZALL   -> List( INST_VALID , READ_ENABLE   , READ_DISABLE    , FU_BR , EXE_LTZAL, WRITE_ENABLE   , WRA_T3 , IMM_N  , DUAL_ISSUE),

      // // TLB
      TLBP  -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_TLB, EXE_TLBP, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
      TLBR  -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_TLB, EXE_TLBR, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
      TLBWI -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_TLB, EXE_TLBWI, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
      TLBWR -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_TLB, EXE_TLBWR, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
      ...
      // WAIT      -> List( INST_VALID , READ_DISABLE    , READ_DISABLE    , FU_EX, EXC_WAIT, WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
      ...
      // SC        -> List( INST_VALID  , READ_ENABLE   , READ_ENABLE     , FU_MEM, EXE_SC  , WRITE_DISABLE  , WRA_T2 , IMM_N  , DUAL_ISSUE),

      // SYNC      -> List( INST_VALID  , READ_DISABLE  , READ_ENABLE  , FU_NOP, EXE_NOP , WRITE_DISABLE  , WRA_X  , IMM_N  , DUAL_ISSUE),
