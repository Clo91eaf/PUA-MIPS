...
class Decoder extends Module {
  ...
  val signals: List[UInt] = ListLookup(
    ...
    Array( /* inst_valid | reg1_ren | reg2_ren | fusel | op | reg_wen | reg_waddr | imm_type | dual_issue */
      ...
      // C0的Move指令
      MFC0 -> List(INST_VALID, READ_DISABLE, READ_DISABLE, FU_MFC0, EXE_MFC0, WRITE_ENABLE, WRA_T2, IMM_N, SINGLE_ISSUE),
      MTC0 -> List(INST_VALID, READ_DISABLE, READ_ENABLE, FU_MTC0, EXE_MTC0, WRITE_DISABLE, WRA_X, IMM_N, SINGLE_ISSUE),
