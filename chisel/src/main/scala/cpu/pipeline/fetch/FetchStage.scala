...
class FetchStage extends Module {
  ...
  fs_to_ds_valid := fs_valid && ready_go && !io.fromWriteBackStage.eret && !io.fromWriteBackStage.ex
  ...
  when(!inst_buff_valid && fs_valid && io.fromInstMemory.data_ok && !io.fromDecoder.allowin) {
