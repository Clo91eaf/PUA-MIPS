...
import Const._
import scala.meta.internal.javacp.BaseType
...
class WriteBackStage_CP0 extends Bundle {
  ...
  val ws_after_tlb        = Output(Bool())
  val ws_inst_is_eret     = Output(Bool())
  val ex_tlb_refill_entry = Output(Bool())
}
